...
def seed(db):
    users = [User(id = 1, username = "Sarah"),
    User(id = 2, username = "Carolyn"),
    User(id = 3, username = "Emma"),
    User(id = 4, username = "Amy"),
    User(id = 5, username = "Kat")
    ...
    Post(id = 13, content = "Goodnight", user_id = 3)
